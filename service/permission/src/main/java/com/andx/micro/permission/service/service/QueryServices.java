 ...
 */
@Component
@com.andx.micro.api.core.Service(path = "/services", code = "queryServices", name = "查询服务", module = "权限")
public class QueryServices extends GetSampleService<PageResponse<List<ServiceDto>>> {
    ...
    public PageResponse<List<ServiceDto>> doService(Map<String, String[]> stringMap, String path) throws ServiceException {
        ...
        qs.setCode(stringMap.get("code") != null ? stringMap.get("code")[0] : null);
        qs.setMethod(stringMap.get("method") != null ? MethodType.valueOf(stringMap.get("method")[0]) : null);
        qs.setIsAudit(stringMap.get("isAudit") != null ? Integer.valueOf(stringMap.get("isAudit")[0]) : null);
        Example<Service> example = Example.of(qs);
        int page = Integer.parseInt(stringMap.get("page") != null ? stringMap.get("page")[0] : "0");
        int size = Integer.parseInt(stringMap.get("size") != null ? stringMap.get("size")[0] : "5");
