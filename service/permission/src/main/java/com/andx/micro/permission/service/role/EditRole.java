 ...
 */
@Component
@Service(path = "/role/\\w+", code = "editRole", method = MethodType.PUT, name = "编辑角色", module = "permission")
public class EditRole extends PutSampleService<Request<RoleDto>, Response<RoleDto>> {
