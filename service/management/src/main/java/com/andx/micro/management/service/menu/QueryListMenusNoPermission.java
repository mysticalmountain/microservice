 ...
 */
@Component
@Service(path = "/list-menus/noPermission", code = "queryListMenusNoPermission", method = MethodType.GET, name = "查询未添加权限的菜单", module = "management")
public class QueryListMenusNoPermission extends GetComplexService<Response<List<MenuDto>>> {
    ...
    protected Response<List<MenuDto>> doService(Map<String, String> prams, String path, ServiceContext context) throws ServiceException {
        return permissionClient.queryListMenusNoPermission(Constant.MODULE, prams.get(Constant.KEY_REQUEST_ID));
    }
}
