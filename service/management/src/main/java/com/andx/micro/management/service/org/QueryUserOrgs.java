 ...
 */
@Component
@Service(path = "/user/orgs", code = "queryUserOrgs", name = "查询用户机构", module = "management")
public class QueryUserOrgs extends GetComplexService<Response<List<OrgDto>>> {
    ...
    protected Response<List<OrgDto>> doService(Map<String, String> prams, String path, ServiceContext context) throws ServiceException {
        ...
        return userClient.queryListOrgs(orgId, Constant.MODULE, prams.get(Constant.KEY_REQUEST_ID));
    }
}
