 ...
 */
@Component
public class DeleteExecuteComplex implements ExecuteTemplate<Map<String, String>, ComplexService, Response> {
    ...
    @Override
    public Response execute(Map<String, String> prams, ComplexService processor, Object... args) throws ServiceException {
